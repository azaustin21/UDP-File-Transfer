...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--www", type=str, default=os.path.join(os.getcwd(), "input", "receiver"),
                        help="Destination folder for receipt, default: /<Current Working Directory>/input/receiver/")
