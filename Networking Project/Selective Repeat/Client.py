...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--www", type=str, default=os.path.join(os.getcwd(), "input", "sender"),
                        help="Source folder for transmission, default: /<Current Working Directory>/input/sender/")
